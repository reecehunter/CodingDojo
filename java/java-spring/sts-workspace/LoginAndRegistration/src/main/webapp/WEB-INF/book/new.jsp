...
<body>
	...
	<form:form action="/books/process/new" method="POST" modelAttribute="newBook" class="container">
		<form:input path="user" class="form-control" type="hidden" value="${user.id}"/>
